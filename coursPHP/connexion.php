...
$db="benedictdourlens"; // le nom de votre base de données.
            // A l IUT, 3 possibilité prenomnom prenomnom1... 

$user="benedict.dourlen"; // nom d utilisateur pour se connecter
              // A l iut prenom.nom	

$passwd="jt52qu8w"; // mot de passe de l utilisateur pour se connecter
